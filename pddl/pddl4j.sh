...
solveHSP(){
	read -rp "Enter domain file [path to the file]: " domainFile
	read -rp "Enter problem file [path to the file]: " problemFile
	read -rp "Timeout [int]: " timeOut

	show_heuristic

	read -rp "Choose heuristic [0 - 8]: " h
